...
public class Utils {
    ...
    /*public static HashMap<String, Map<String, Boolean>> getRandomMathQuestions(int SIZE){
        HashMap<String,Map<String,Boolean>> questions = new HashMap<>();

        HashMap<String,Boolean> answer1 = new HashMap<>();
        answer1.put("un système qui permet de recevoir des vidéos",true);
        answer1.put("Robert Hass",false);
        answer1.put("un système qui permet de gérer une file d'attente asynchrone",false);
        answer1.put("un système qui permet de gérer le sms non sollicités",false);
        answer1.put("un système qui permet de faire communiquer grâce à des messages, pour de multiples utilisations ",false);
        questions.put("C'est quoi un BroadCastReceiver chez android?",answer1);

        HashMap<String,Boolean> answer2 = new HashMap<>();
        answer2.put("Activity ",true);
        answer2.put("Service",false);
        answer2.put("Content Provider",false);
        answer2.put("Wave Provider",false);
        questions.put("quelles sont les composantes qui existe sous Android?",answer2);
