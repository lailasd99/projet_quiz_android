...
public class LoginActivityADMIN extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvSignUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(LoginActivityADMIN.this,RegisterActivity.class));
            }
        });
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            for (User user : users){
                if (username.equals(user.getUsername()) && password.equals(user.getPassword())){
                    SharedPref sharedPref = SharedPref.getInstance();
                    sharedPref.setUser(LoginActivityADMIN.this,user);
                    startActivity(new Intent(LoginActivityADMIN.this,MainActivityADMIN.class));
                    return;
                }
            }
            Toast.makeText(LoginActivityADMIN.this, "User not exist", Toast.LENGTH_SHORT).show();
