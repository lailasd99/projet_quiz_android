...
public class RegisterActivityADMIN extends AppCompatActivity {
    ...
    class RegisterUserTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (isOkay){
                Toast.makeText(RegisterActivityADMIN.this, "User Created!", Toast.LENGTH_SHORT).show();
                SharedPref sharedPref = SharedPref.getInstance();
                sharedPref.setUser(RegisterActivityADMIN.this,user);
                Intent intent = new Intent(RegisterActivityADMIN.this,MainActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
                finish();
            }else{
                Toast.makeText(RegisterActivityADMIN.this, "This email is already using by someone else", Toast.LENGTH_SHORT).show();
            }
