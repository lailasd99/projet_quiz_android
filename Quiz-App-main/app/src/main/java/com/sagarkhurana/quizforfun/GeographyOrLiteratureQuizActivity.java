...
public class GeographyOrLiteratureQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displayData();
            ...
            @Override
            public void onClick(View view) {
                Toast.makeText(GeographyOrLiteratureQuizActivity.this, "Quiz is filled successfully", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(GeographyOrLiteratureQuizActivity.this, MainActivity.class));
            }
        });
    }
